...
#define XDP_DISTILL_CLASSES 14
#define XDP_DISTILL_BUCKETS 4096
#define XDP_DISTILL_PROMPT_BYTES 16384
...
#pragma unroll
  ...
  bpf_map_update_elem(&xdp_distill_last_prediction, &key, &debug, BPF_ANY);
  return best;
}
