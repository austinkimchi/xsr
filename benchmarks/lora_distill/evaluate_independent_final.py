...
from core import LABELS, LABEL_TO_ID, feature_indices, predict, read_jsonl
...
def stratified_cluster_bootstrap(
    ...
    samples = {name: {metric: [] for metric in ("accuracy", "teacher_agreement")}
               for name in ("teacher", "supervised", "distilled")}
...
def main() -> None:
    ...
    report = {
        ...
        "selection_status": "8K linear architecture and weights locked before evaluation",
