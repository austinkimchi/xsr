...
.venv-distill/bin/python benchmarks/lora_distill/rebalance_experiment.py \
  ...
  --summary-output results/intent-distillation/rebalance/summary.json
```
...
.venv-distill/bin/python benchmarks/lora_distill/prepare_expanded_training.py \
  ...
  --summary results/intent-distillation/expanded/manifest_summary.json \
  --train-per-class 350
...
.venv-distill/bin/python benchmarks/lora_distill/expanded_data_experiment.py \
  ...
  --report results/intent-distillation/expanded/summary.json
```
...
.venv-distill/bin/python benchmarks/lora_distill/hash_width_experiment.py \
  --manifest benchmarks/lora_distill/artifacts/manifest_expanded.jsonl \
  --teacher-targets benchmarks/lora_distill/artifacts/teacher_targets_expanded.jsonl \
  --manifest-summary results/intent-distillation/expanded/manifest_summary.json \
  --baseline-report results/intent-distillation/expanded/summary.json \
  --output-dir benchmarks/lora_distill/artifacts/model_hash_width \
  --report results/intent-distillation/hash-width/summary.json
```
...
.venv-distill/bin/python benchmarks/lora_distill/model_capacity_experiment.py \
  ...
  --teacher-targets benchmarks/lora_distill/artifacts/teacher_targets_expanded.jsonl \
  --manifest-summary results/intent-distillation/expanded/manifest_summary.json \
  --hash-width-report results/intent-distillation/hash-width/summary.json \
  --output-dir benchmarks/lora_distill/artifacts/model_capacity \
  --report results/intent-distillation/model-capacity/summary.json
```
